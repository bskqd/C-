...
//-----------------------------------------------------------------------------
	...
	SignData: function(data, asBase64String) {
		...
		var pPtrBASE = EUPointer();
		console.log(pPtrBASE)

		var pPtr2NoBase = EUPointerArray();
		console.log(pPtr2NoBase)
		...
		try {
			...
			error = Module.ccall('EUSignData',
				...
				['array', 'number', 'number', 'number', 'number'],
				[data, data.length,
					asBase64String ? pPtrBASE.ptr : 0,
					!asBase64String ? pPtr2NoBase.ptr : 0,
					!asBase64String ? pPtr2NoBase.lengthPtr : 0]);
		...
		signArr.push(pPtrBASE.toString())
		signArr.push(pPtr2NoBase.toArray())
