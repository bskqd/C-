    ...
    <template #header>
      <div class="flex-row-sb">
        ...
        <div class="documentIconControl">
          ...
          />
          <unicon
            v-if="sailorDocument.allowChange && checkAccess(type, 'edit')"
          ...
          />
          <unicon
            v-if="sailorDocument.allowChange && checkAccess(type, 'delete')"
          ...
          />
          <unicon
            @click="back('coefficients-backoffice')"
            name="multiply"
            fill="#42627e"
            height="25px"
            width="25px"
...
<script src="./BackOfficeCoefficientsDocument.js" />
