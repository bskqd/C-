  ...
  <b-form @submit.prevent="checkInfo">
    <div class="col-12 text-left mb-1">
      ...
      <multiselect
        ...
        :options="checkAccess('experience', 'checkDocumentType') ? dataForm.mappingTypeDoc : dataForm.mappingConventionalTypeDoc"
        :allow-empty="false"
        :preselectFirst="true"
        :searchable="true"
    ...
    <div
      v-if="dataForm.typeDoc && dataForm.typeDoc.id === 2"
      class="text-left"
    >
    ...
    <div
      v-else-if="dataForm.typeDoc && dataForm.typeDoc.id === 1"
      class="text-left"
    >
      <div class="flex-row-sb form-group mt-2">
        <div class="col-6">
          ...
          <multiselect
            v-model="dataForm.responsibilityWorkBook"
            @close="$v.dataForm.responsibilityWorkBook.$touch()"
          ...
          />
          <ValidationAlert
            v-if="$v.dataForm.responsibilityWorkBook.$dirty && !$v.dataForm.responsibilityWorkBook.required"
            :text="$t('emptyField')"
          />
        </div>
        <div class="col-6">
          ...
          <b-input
            ...
            @blur="$v.dataForm.workPlace.$touch()"
            :placeholder="$t('workPlace')"
            type="text"
          />
          <ValidationAlert
            v-if="$v.dataForm.workPlace.$dirty && !$v.dataForm.workPlace.required"
            :text="$t('emptyField')"
          />
        </div>
      </div>
      ...
      <div class="flex-row-sb form-group mt-2">
        <div class="col-4">
          ...
          <b-input-group>
            <b-form-input
              ...
              @blur="$v.dataForm.dateStart.$touch()"
              :readonly="Boolean(dataForm.totalDays)"
              type="date"
            />
            <b-input-group-append>
              <b-form-datepicker
                v-model="dataForm.dateStart"
                @hidden="$v.dataForm.dateStart.$touch()"
                :disabled="Boolean(dataForm.totalDays)"
                :locale="lang"
                :max="dataForm.dateEnd"
                min="1900-01-01"
                start-weekday="1"
                button-only
                right
          ...
          <ValidationAlert
            v-if="$v.dataForm.dateStart.$dirty && !$v.dataForm.dateStart.required"
            :text="$t('emptyField')"
          />
        </div>
        <div class="col-4">
          ...
          <b-input-group>
            ...
            <b-input-group-append>
              <b-form-datepicker
                v-model="dataForm.dateEnd"
                @hidden="$v.dataForm.dateEnd.$touch()"
                :disabled="Boolean(dataForm.totalDays)"
                :locale="lang"
                start-weekday="1"
                :max="new Date()"
          ...
          <ValidationAlert
            v-if="$v.dataForm.dateEnd.$dirty && !$v.dataForm.dateEnd.required"
            :text="$t('emptyField')"
          />
        </div>
        <div class="col-1 d-flex justify-content-center align-items-center">
        ...
        <div class="col-3">
          ...
          <b-form-input
            v-model="dataForm.totalDays"
            @blur="$v.dataForm.totalDays.$touch()"
            :readonly="Boolean(dataForm.dateEnd || dataForm.dateStart)"
            :placeholder="$t('totalDays')"
            type="number"
          />
          <ValidationAlert
            v-if="$v.dataForm.totalDays.$dirty && !$v.dataForm.totalDays.required"
            :text="$t('emptyField')"
          />
        </div>
      </div>
      ...
      <div class="flex-row-sb form-group">
        <div class="col-12">
          ...
          <div class="d-flex justify-content-start align-items-center">
            <b-form-checkbox
              v-model="dataForm.bookPracticalWorkBook"
              name="bookPractical"
              class="mx-1"
              switch
            />
            <div v-if="dataForm.bookPracticalWorkBook">
              {{ $t('present') }}
            </div>
            <div v-else>
              {{ $t('missingFemale') }}
...
<script src="./SailorExperienceAdd.js"/>
