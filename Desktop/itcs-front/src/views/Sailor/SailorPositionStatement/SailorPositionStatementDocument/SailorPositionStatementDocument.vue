    ...
    <template #header>
      <div class="flex-row-sb">
        <div class="text-uppercase text-left">
          {{ $t(`${Object.keys(sailorDocument.behavior)[0]}-${type}`, { number: sailorDocument.full_number }) }}
        ...
        <div class="documentIconControl">
          ...
          />
          <unicon
            @click="back('position-statements')"
            name="multiply"
            fill="#42627e"
            height="25px"
            width="25px"
...
<script src="./SailorPositionStatementDocument.js" />
